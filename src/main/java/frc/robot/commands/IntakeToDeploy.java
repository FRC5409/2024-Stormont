...
public class IntakeToDeploy extends SequentialCommandGroup {
  ...
  public IntakeToDeploy(Deployment sys_deployment, Cartridge sys_cartridge, Intake sys_intake, Indexer sys_indexer) {
    ...
    addCommands(
        ...
        Commands.runOnce(() -> sys_deployment.setPosition(Constants.kDeployment.kSetpoints.LOW), sys_deployment),
        Commands.waitUntil(() -> sys_deployment.atSetpoint(Constants.kDeployment.kSetpoints.LOW)),
